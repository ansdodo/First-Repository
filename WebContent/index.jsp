...
%>	
				<li class="nav-item active ms-3 mt-2">
				 	<%=id %>님 환영합니다.
				</li>
			</ul>
	...
	<section class="container">
		<form method="get" action="./index.jsp" class="d-inline mt-3">
			<select name="lectureDivide" class="form-select w-10 d-inline">
			...
			<select name="searchType" class="form-select w-10 d-inline">
				<option value="최신순">최신순</option>
				<option value="추천순" <% if(searchType.equals("추천순")) out.println("selected"); %>>추천순</option>
			</select>
			<input type="text" name="search" class="form-control mx-1 mt-2 w-25 d-inline" placeholder="내용를 입력하세요.">
			<button type="submit" class="btn btn-primary me-1 mt-0">검색</button>
			<a class="btn btn-primary me-1 mt-0" data-bs-toggle="modal" href="#registerModal">등록하기</a>
			<a class="btn btn-danger mt-0" data-bs-toggle="modal" href="#reportModal">신고</a>
		</form>
<%
...
%>
	...
	<div class="modal fade" id="registerModal" tabindex="-1" role="dialog" aria-labelledby="modal" aria-hidden="">
			...
			<div class="modal-content">
				...
				<div class="modal-body" >
					<form action="./evaluationRegisterAction.jsp" method="post">
						<div class="row">
							<div class="col-auto col-sm-5 mt-2 me-3">
								<label>강의명</label>
								<input type="text" name="lectureName" class="form-control mt-1" maxlength="20">
							</div>
							<div class="col-auto col-sm-5 mt-2">
								<label>교수명</label>
								<input type="text" name="professorName" class="form-control mt-1" maxlength="20">
							</div>
							<div class="row">
								<div class="form-group col-sm-3 mt-3 me-2">
									<label>수강 연도</label>
									<select name="lectureYear" class="form-select mt-1">
								...
								<div class="form-group col-sm-3 mt-3 me-2">
									<label>수강 학기</label>
									<select name="semesterDivide" class="form-select mt-1">
								...
								<div class="form-group col-sm-3 mt-3 me-2">
									<label>강의 구분</label>
									<select name="lectureDivide" class="form-select mt-1">
							...
							<div class="row">
								<div class="form-group col-sm-13 mt-3 me-1">
									<label>종합</label>
									<select name="totalScore" class="form-select mt-1">
								...
								<div class="form-group col-sm-13 mt-3 me-1">
									<label>성적</label>
									<select name="creditScore" class="form-select mt-1">
										<option value="A" selected>A</option>
										<option value="B">B</option>
										<option value="C">C</option>
										<option value="D">D</option>
								...
								<div class="form-group col-sm-13 mt-3 me-1">
									<label>널널</label>
									<select name="comfortableScore" class="form-select mt-1">
										<option value="A" selected>A</option>
										<option value="B">B</option>
										<option value="C">C</option>
										<option value="D">D</option>
								...
								<div class="form-group col-sm-13 mt-3">
									<label>강의</label>
									<select name="lectureScore" class="form-select mt-1">
										<option value="A" selected>A</option>
										<option value="B">B</option>
										<option value="C">C</option>
										<option value="D">D</option>
	...
	<div class="modal fade" id="reportModal" tabindex="-1" role="dialog" aria-labelledby="modal" aria-hidden="">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
